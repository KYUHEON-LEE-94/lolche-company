                            ...
                            {navItems.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {item.label}
                                        {active && (
                                            <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-xl blur-xl opacity-50 group-hover:opacity-60 transition-opacity -z-10" />
                                        )}
                                    </Link>
                                )
                            })}
