...
const TIER_COLORS: Record<string, { text: string; bg: string; border: string }> = {
    ...
    GRANDMASTER: { text: 'text-danger-ink',     bg: 'bg-red-500/10',     border: 'border-red-500/20' },
    ...
    EMERALD:     { text: 'text-ok-ink', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20' },
    PLATINUM:    { text: 'text-cyan-400',    bg: 'bg-cyan-500/10',    border: 'border-cyan-500/20' },
    GOLD:        { text: 'text-warn-ink',   bg: 'bg-amber-500/10',   border: 'border-amber-500/20' },
    SILVER:      { text: 'text-muted',   bg: 'bg-slate-500/10',   border: 'border-slate-500/20' },
    ...
    return (
        <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
                ...
                <p className="text-[11px] font-bold text-subtle tracking-widest">
            ...
            <div className={`text-right rounded-xl border px-3 py-2 ${colors.bg} ${colors.border}`}>
                <p className="text-lg font-black text-fg leading-none tabular-nums">{lp}</p>
                <p className="text-[10px] font-bold text-subtle tracking-widest mt-0.5">LP</p>
            </div>
        </div>
    )
}