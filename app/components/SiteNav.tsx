    ...
    <div className="relative" ref={boxRef}>
      ...
      {open && (
        <div role="menu" className="absolute right-0 top-full z-50 mt-2 w-72 overflow-hidden rounded-2xl border border-line bg-panel/95 shadow-[0_24px_64px_-24px_var(--color-shadow)] backdrop-blur-xl">
          ...
          <Link href="/points" onClick={() => setOpen(false)} className="block border-t border-line px-4 py-2.5 text-center text-xs font-bold text-brand-ink transition-colors hover:bg-surface-2">
            포인트 내역 상세 보기 →
          </Link>
        </div>
      )}
